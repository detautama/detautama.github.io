...
export const Header = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-claude-tan bg-claude-cream/95 backdrop-blur-md md:hidden dark:border-claude-dark-border dark:bg-claude-dark-bg/95">
