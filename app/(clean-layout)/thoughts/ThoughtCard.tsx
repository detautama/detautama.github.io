...
export const ThoughtCard: React.FC<ThoughtCardProps> = ({
  ...
  return (
    <article className="brand-card flex flex-col gap-3 p-5">
      <time className="dark:text-brand-dark-text/50 text-xs text-brand-text-secondary">
      ...
      {thought.image && (
        <div className="border-brand-accent/20 relative mt-1 overflow-hidden border">
          <Image
            src={thought.image}
            alt=""
            width={600}
